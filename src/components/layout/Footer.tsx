...
import EllipseOrangeSolid from "@assets/images/ellipse-orange-solid.svg";
    ...
    <footer className="bg-[#121212]">
      <div className="mx-auto flex max-w-360 items-center justify-between px-20 py-3">
        <div className="w-full px-20 pt-20 pb-7.5">
          ...
          <div className="mt-18.75 flex w-full items-end justify-between px-2.5">
            ...
            <Badge
              variant="outline"
              color="#489B1C"
              className="badge-text flex items-center border-[0.5px] border-[#FFFFFF26] bg-[#489B1C]/13 text-[#489B1C]"
            >
              <img src={EllipseOrangeSolid} alt="SYSTEM_OPERATIONAL" />
              SYSTEM_OPERATIONAL
            </Badge>
          </div>
        </div>
