    ...
    <nav className="fixed top-0 right-0 left-0 z-50 border-b-[0.5px] border-b-white/8 backdrop-blur-xl">
      <div className="mx-auto flex max-w-360 items-center justify-between px-20 py-3">
        ...
        <div className="flex flex-row items-center gap-8 text-sm">
          ...
          >
            <DecryptedText animateOn="both" text="// PRODUCT" />
          </a>
          ...
          <a
            ...
            className="opacity-50 transition-opacity hover:opacity-100"
          >
            <DecryptedText animateOn="both" text="// HIGHLIGHT" />
          </a>
          <Separator orientation="vertical" color="#383838" />
          <a
            href="#"
            className="opacity-50 transition-opacity hover:opacity-100"
          >
            <DecryptedText animateOn="both" text="// ABOUT_US" />
          </a>
        </div>
        <div>
          <Button className="text-lg">JOIN THE WAITLIST</Button>
        </div>
      </div>
    </nav>
  );
