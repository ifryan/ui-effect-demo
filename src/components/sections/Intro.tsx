      ...
      <CornersPlus showCorners="bottom">
        <div className="flex -gap-0.25">
          <div className="dashed-border-4-4-r flex-554">
            ...
            <div className="relative flex flex-col items-center justify-center h-90">
              <div
                className="absolute inset-0 bg-center bg-no-repeat opacity-17"
                style={{
          ...
          <div className="flex-723">
            ...
            <div className="relative p-4 flex flex-col items-center justify-center h-90">
              <div
                className="absolute inset-0 bg-center bg-no-repeat opacity-17"
                style={{
                  backgroundImage: `url(${Pattern})`,
